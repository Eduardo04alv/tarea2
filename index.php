            ...
            if (is_dir($ruta)) {
                ...
                foreach ($archivos as $archivo) {
                    if (pathinfo($archivo, PATHINFO_EXTENSION) === 'json') {
                        ...
                        $codigo = htmlspecialchars($obra->codigo ?? '');
                        ...
                        echo "<td>
                            <a href='personajes.php?codigo_obra={$obra->codigo}' class='btn btn-info'>Ver personajes</a>
                            <a href='editar.php?codigo={$obra->codigo}' class='btn btn-warning'>Editar</a>
                            <a href='eliminar.php?codigo_obra={$codigo}' class='btn btn-danger'>Eliminar</a>
                        </td>";
                        echo "</tr>";
                    }
                }
